export const journalPosts = [
  {
    ...
    conclusion: {
      title: "A Meditation on Stillness",
      content: "There is a calm in Amboseli that lingers long after you leave. It's in the warmth of the morning sun, the gentle sway of acacias, and the quiet harmony between every living thing on the plains. This is not just a destination it is a return to yourself.",
      image: "https://i.ibb.co/sv3xt3bf/IMG-0009.jpg"
    }
  },
  {
    ...
    conclusion: {
      title: "A Meditation by the Shore",
      content: "Zanzibar carries a stillness that lingers long after you leave. It's in the warm breeze, the gentle roll of waves, and the effortless harmony between sky and sea. This is not just an island it is a feeling you return to.",
      image: "https://i.ibb.co/cc85JsnD/IMG-4232.jpg"
    }
  },
  {
    ...
    conclusion: {
      title: "A Quiet Conversation with Light",
      content: "Cape Town teaches a slower rhythm one shaped by tides, winds, and shifting skies. In the early calm, you feel it: a gentle grounding, a soft reminder that beauty often whispers long before it calls your name. This place is more than a landscape. It is a breath, a pause, a beginning.",
      image: "https://i.ibb.co/HT5WdscB/IMG-7680-1.jpg"
    }
  }
];
